...
const RoomCardMini = () => {
  return (
    <div className="min-w-[280px] w-[280px] border border-orange-200 rounded-xl p-1 px-2 flex flex-row gap-2 items-center justify-between shadow-[10px_2px_12px_rgba(0,0,0,.1)] ">
